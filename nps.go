...
type NPParticleSystem struct {
	particles map[*Particle]struct{}
}

func NewNPParticleSystem() *NPParticleSystem {
...
func (ps *NPParticleSystem) Update() {
...
func (ps *NPParticleSystem) Draw(screen *ebiten.Image, cam Cam) {
